...
export type Plan = {
  ...
  // phase 5: where the idea came from and how long it is meant to live
...
export type Trade = {
  ...
  // phase 5 (optional so older rows and fixtures still type): nightly | sit | shadow, the strategy id, the timeframe, hours for scalps
  ...
  // phase 7: the ticket (everything that went into the trade) and a frontier's request to close at the next quote
