...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  death: { label: "death line", meaning: "the book value at which a team dies: 25% below where it started, pushed lower by any cushion it earned" },
  vest: { label: "life vest", aliases: ["life vests"], meaning: "earned by a +$5,000 day; when the book hits the death line the vest is spent instead of the team and the book is refilled to its start" },
  cushion: { label: "cushion", meaning: "earned by a +$10,000 day; the death line drops $10,000 for the rest of the team's life" },
  guns: { label: "bigger guns", meaning: "earned by a +$20,000 day; the most the frontier may risk on one trade rises by one point of the book" },
  shield: { label: "shield", aliases: ["shielded"], meaning: "earned by a +$30,000 day; the team cannot be relegated at the next ranking" },
  playbook: { label: "own playbook", aliases: ["own idea", "own ideas", "own-playbook"], meaning: "a trade the frontier came up with itself from the news and the tape, under a name it chose, rather than one of the eight coded strategies" },
